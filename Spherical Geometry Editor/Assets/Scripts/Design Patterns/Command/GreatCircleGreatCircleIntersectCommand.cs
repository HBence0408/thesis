...
public class GreatCircleGreatCircleIntersectCommand : ICommand
{
    ...
    public GreatCircleGreatCircleIntersectCommand(GreatCircle greatCircle1, GreatCircle greatCircle2, IntersectDrawState.CreatePointDelegate createPoint, GameObject prefab)
    {
